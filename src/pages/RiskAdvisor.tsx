        ...
        <section class="problem-section" style={{ padding: "6rem 0", background: "var(--color-white)" }}>
          <div class="container">
            <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto 4rem auto" }}>
              ...
              <p style={{ fontSize: "1.125rem" }}>Is your risk management reactive, manual, and struggling to keep pace with evolving threats?</p>
            </div>
            <div class="pain-grid">
        ...
        <section class="solution-details" style={{ padding: "6rem 0", background: "var(--color-off-white)" }}>
          <div class="container">
            <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto 4rem auto" }}>
              ...
              <p style={{ fontSize: "1.125rem" }}>Proactive risk management with AI-powered early warning systems and automated mitigation playbooks.</p>
            </div>
            ...
            <div style={{ marginTop: "4rem", background: "var(--color-navy)", padding: "2rem", color: "white", borderRadius: "8px" }}>
              <h3 style={{ color: "var(--color-teal)", marginBottom: "1rem" }}>COMPREHENSIVE RISK COVERAGE</h3>
