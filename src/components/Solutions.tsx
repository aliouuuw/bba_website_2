export default function Solutions() {
  return (
    <section id="solutions" class="solutions dark-section">
      <div class="container">
        <div class="reveal-up" style={{ marginBottom: "6rem", textAlign: "right" }}>
        ...
        <div class="solution-row reveal-slide">
          <div class="solution-content">
            <h3 style={{ marginBottom: "1rem" }}>AI STRATEGIC COMMAND CENTER</h3>
            <p style={{ marginBottom: "2rem" }}>Your AI co-pilot for market leadership. See where you stand—and where to go next.</p>
            <ul class="font-mono" style={{ listStyle: "none", marginBottom: "2rem", fontSize: "0.875rem" }}>
              <li style={{ marginBottom: "0.5rem" }}>• AI‑Generated Strategic Plans and advisory</li>
              <li style={{ marginBottom: "0.5rem" }}>• Climate & Macro‑Risk Scenarios</li>
              <li style={{ marginBottom: "0.5rem" }}>• Competitive Benchmarking</li>
              <li style={{ marginBottom: "0.5rem" }}>• Market Opportunity Analysis</li>
            </ul>
        ...
        <div class="solution-row reverse reveal-slide">
          <div class="solution-content">
            <h3 style={{ marginBottom: "1rem" }}>AI RISK ADVISOR PLATFORM</h3>
            <p style={{ marginBottom: "2rem" }}>Predict, monitor, and mitigate financial risks before they impact your business.</p>
            <ul class="font-mono" style={{ listStyle: "none", marginBottom: "2rem", fontSize: "0.875rem" }}>
              <li style={{ marginBottom: "0.5rem" }}>• Early Warning System</li>
              <li style={{ marginBottom: "0.5rem" }}>• Real‑Time Liquidity Monitoring</li>
              <li style={{ marginBottom: "0.5rem" }}>• Automated Mitigation Playbooks</li>
            </ul>
        ...
        <div class="solution-row reveal-slide">
          <div class="solution-content">
            <h3 style={{ marginBottom: "1rem" }}>AI COMPLIANCE CO-PILOT</h3>
            <p style={{ marginBottom: "2rem" }}>Turn regulatory burden into strategic advantage. From data to submission.</p>
            <ul class="font-mono" style={{ listStyle: "none", marginBottom: "2rem", fontSize: "0.875rem" }}>
              <li style={{ marginBottom: "0.5rem" }}>• Pre‑built RegTech Templates (Basel, IFRS 9, AML/KYC)</li>
              <li style={{ marginBottom: "0.5rem" }}>• Drag‑and‑Drop Report Builder</li>
              <li style={{ marginBottom: "0.5rem" }}>• Granular Data Lineage & Audit Trail</li>
            </ul>
